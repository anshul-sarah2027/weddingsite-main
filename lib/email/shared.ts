...
export const IVORY = "#FAF7F2";
export const PAPER = "#FFFCFA";
export const FOREST = "#2F3A2E";
export const GOLD = "#B59A63";
export const FOREST_SOFT = "rgba(47,58,46,0.72)";
...
export function detailCard(label: string, content: string) {
  return `
