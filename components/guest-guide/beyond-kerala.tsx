...
import {
  beyondKeralaDestinations,
  beyondKeralaIntro,
} from "@/constants/guest-guide";

export function BeyondKerala() {
  return (
    <GuideSection
      id="beyond-kerala"
      ariaLabel="Beyond Kerala"
      eyebrow="Extending Your Trip"
      title="Beyond Kerala"
      intro={beyondKeralaIntro}
      tone="sage"
    >
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {beyondKeralaDestinations.map((destination, index) => (
